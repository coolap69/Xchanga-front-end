...
var addNestedValue = __webpack_require__(2);
...
var adevents = __webpack_require__(14);
$(function () {
...
var userUi = __webpack_require__(12);
...
var onSignUp = function onSignUp(event) {
  ...
  console.log(data);
  userApi.signUp(data).then(userUi.onSignUpSuccess).catch(userUi.onSingUpFailure);
};

var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  userApi.signIn(data).then(userUi.onSignInSuccess).catch(userUi.onSignInFailure);
};

var onChangePassword = function onChangePassword(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  userApi.changePassword(data).then(userUi.onChangePasswordSuccess).catch(userUi.onChangePasswordFailure);
};

var onSignOut = function onSignOut(event) {
  event.preventDefault();
  userApi.signOut().then(userUi.onSignOutSuccess).catch(userUi.onSignOutFailure);
};
...
var hideGame = function hideGame() {
  $(function () {
    console.log('in the beginning');
    $('.game').children().show();
    console.log('Success');
...
var adsApi = __webpack_require__(15);
var adsUi = __webpack_require__(16);
var getFormFields = __webpack_require__(3);

var onCreateAd = function onCreateAd(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  adsApi.createAd(data).then(adsUi.onCreateAdSuccess).catch(adsUi.onCreateAdFailure);
};

var onGetAds = function onGetAds(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  adsApi.getAds(data).then(adsUi.onGetAdsSuccess).catch(adsUi.onGetAdsFailure);
};

var onShowAd = function onShowAd(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  adsApi.showAd(data).then(adsUi.onShowAdSuccess).catch(adsUi.onShowAdFailure);
};

var onDeleteAds = function onDeleteAds(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  adsApi.deleteAds(data).then(adsUi.onDeleteAdsSuccess).catch(adsUi.onDeleteAdsFailure);
};

var onUpdateAd = function onUpdateAd(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  adsApi.updateAd(data).then(adsUi.onUpdateAdSuccess).catch(adsUi.onUpdateAdFailure);
};
...
var createAd = function createAd(data) {
  return $.ajax({
    url: app.host + '/ads/',
    method: 'POST',
    headers: {
...
var getAds = function getAds(data) {
  return $.ajax({
    url: app.host + '/ads/',
    method: 'GET',
    headers: {
...
var showAd = function showAd(data) {
  return $.ajax({
...
var deleteAds = function deleteAds(data) {
  return $.ajax({
    url: app.host + '/ads/' + app.user.id,
    method: 'DELETE',
    headers: {
...
var updateAd = function updateAd(data) {
  return $.ajax({
    url: app.host + '/ads/' + app.user.id,
    method: 'PATCH',
    headers: {
...
var onCreateAdSuccess = function onCreateAdSuccess(data) {
...
var onCreateAdFailure = function onCreateAdFailure(response) {
  console.log(response);
  console.log('err');
};

var onGetAdsSuccess = function onGetAdsSuccess(data) {
  console.log('You got an Ad');
  console.log(data);
};

var onGetAdsFailure = function onGetAdsFailure(response) {
  console.log(response);
  console.log('err');
};

var onShowAdSuccess = function onShowAdSuccess(data) {
  console.log('You showing an Ad');
  console.log(data);
};

var onShowAdFailure = function onShowAdFailure(response) {
  console.log(response);
  console.log('err');
};

var ondeleteAdsSuccess = function ondeleteAdsSuccess(data) {
  console.log('You deleting Ads');
  console.log(data);
};

var ondeleteAdsFailure = function ondeleteAdsFailure(response) {
  console.log(response);
  console.log('err');
};

var onupdateAdSuccess = function onupdateAdSuccess(data) {
  console.log('You deleting an Ad');
  console.log(data);
};

var onupdateAdFailure = function onupdateAdFailure(response) {
  console.log(response);
  console.log('err');
};

module.exports = {
  onCreateAdSuccess: onCreateAdSuccess,
  onCreateAdFailure: onCreateAdFailure,
  onGetAdsSuccess: onGetAdsSuccess,
  onGetAdsFailure: onGetAdsFailure,
  onShowAdSuccess: onShowAdSuccess,
  onShowAdFailure: onShowAdFailure,
  ondeleteAdsSuccess: ondeleteAdsSuccess,
  ondeleteAdsFailure: ondeleteAdsFailure,
  onupdateAdSuccess: onupdateAdSuccess,
  onupdateAdFailure: onupdateAdFailure
};
